<nav component="sidebar/left" class="{{{ if config.theme.openSidebars}}}open{{{ end }}} text-dark bg-light sidebar sidebar-left start-0 border-end vh-100 d-none d-lg-flex flex-column justify-content-between sticky-top">
	<ul id="main-nav" class="list-unstyled d-flex flex-column w-100 gap-2 mt-2 overflow-y-auto">
		...
		<li class="nav-item mx-2">
            <a class="nav-link navigation-link d-flex gap-2 justify-content-between align-items-center" href="/report-bug" role="button" aria-label="Report Bug">
                <span class="d-flex gap-2 align-items-center text-nowrap truncate-open">
                    <span class="position-relative">
                        <i class="fa-solid fa-bug" title="Report Bug"></i>
                    </span>
                    <span class="nav-text small visible-open fw-semibold text-truncate hover-effect">Report Bug</span>
                </span>
            </a>
        </li>
